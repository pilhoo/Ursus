...
**
** Created: Thu Apr 1 23:07:41 2010
...
static const char qt_meta_stringdata_PlayListHeader[] = {
    "PlayListHeader\0\0point\0"
    "contextMenuRequested(QPoint)\0"
};

const QMetaObject PlayListHeader::staticMetaObject = {
    { &QHeaderView::staticMetaObject, qt_meta_stringdata_PlayListHeader,
      qt_meta_data_PlayListHeader, 0 }
};
...
int PlayListHeader::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: contextMenuRequested((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
